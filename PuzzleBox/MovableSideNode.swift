...
class MovableSideNode: SCNNode {
    ...
    init(width: Double, height: Double, wallThickness: Double, isLeft: Bool) {
        ...
        let outsideNode = createNodeFrom(geometry: outside, withColor: Wall.outsideColors[sideNumber])
        ...
        let middleNode = createNodeFrom(geometry: middle, withColor: Wall.middleColors[sideNumber])
        ...
        let insideNode = createNodeFrom(geometry: inside, withColor: Wall.insideColors[sideNumber])
    ...
    func resetColor() {
        outside.firstMaterial?.diffuse.contents = Wall.outsideColors[sideNumber]
    }
}
